...
reflectors=("8.8.8.8" "8.8.4.4" "1.1.1.1" "1.0.0.1" "9.9.9.9" "9.9.9.10")
no_pingers=4
...
min_dl_shaper_rate_kbps=75000  # minimum bandwidth for download (Kbit/s)
...
log_file_export_alternative_path="/tmp/cake-autorate_export.log"
