...
# cd to the /jffs/addons directory
cd /jffs/addons/ || exit

# create the cake-autorate directory if it's not present
[[ -d cake-autorate ]] || mkdir cake-autorate

printf "Installing cake-autorate in /jffs/addons/cake-autorate...\n"
...
printf "\n`grep cake_autorate_version /jffs/addons/cake-autorate/cake-autorate_config.sh` successfully installed, but not yet running\n\n"
printf "Start the software manually with:\n"
printf "   cd /jffs/addons/cake-autorate; bash ./cake-autorate.sh\n"
